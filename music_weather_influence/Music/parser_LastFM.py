...
def manage_LastFM_Json():
    for data_file in files_list:
        ...
        if data_file.startswith("LastFM_top_songs_austria_20160429"):
            ...
            #clean_lastfm_data_from_url(directory1, cleaned_directory1, data_file)
...
def test(namefile):
    ...
    basic_functions.save_Json_To_File(cleaned_directory1, "test_LASTFM_json_cleaning", cleaned_Top_Charts)
